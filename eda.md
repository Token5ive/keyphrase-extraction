...
7. [KP당 텍스트 길이 분포](#7-kp당-텍스트-길이-분포-(문자 수))
...
|      기준       |   임계값   |   보존 KP   |   보존율   |   제거율   |
|----------------|----------|------------|----------|----------|
|   IQR 이상치     |    3     |  2,242,289 |   79.8%  |   20.2%  |
| 95% percentile  |   4     |  2,663,628 |   94.8%  |   5.2%   |


> IQR 기준으로 보면 3개 초과 문서가 이상치라고 판단됨,
> 하지만 KP당 단어 수가 너무 이산적 특성을 보이는 것 같고 꼬리값 제거만이 목적이라 생각해 IQR 대신 상위 5%만 제거
